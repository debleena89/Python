...
propose an automated framework that addresses the effect of such replacement attacks from the perspective of loss of control. Given a set of control components, a control
...
the desired control has been recently studied in literature. In this paper, we extend this idea further to 
