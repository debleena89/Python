        ...
        if source[index] == current_state :
          ...
          # is_cycle_accepting()
           ...
           while loop_limit_nested == 1:
                  if position_matrix[source_top][0] != 0 :                      
                          source[source_top + 1] = position_matrix[source_top][0]
                          position_matrix[source_top][0] = 0
                          source_top = source_top + 1  
                          check_cycle()                       
                          break
                  elif source_top == 0:
...
def check_emptyness_of_Buchi_automata(intersection_matrix_for_buchi_automata):
    #intersection_matrix_for_buchi_automata = (['00','A','B'],['a','b','c'],['b','d','e'],['c','b','c'],['d','d','e'],['e','f','g'],['f','b','c'],['g','a','h'],['h','a','h'])
    global position_matrix
    ...
    while loop_limit == 1:          
          ...
          for row_index in range(0,len(intersection_matrix_for_buchi_automata)):
              if intersection_matrix_for_buchi_automata[row_index][0] == current_state :                
                    ...
                    position_matrix[source_top - 1][0] = intersection_matrix_for_buchi_automata[row_index][2]
